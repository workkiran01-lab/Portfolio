    ...
    <section id="about" className="section about-section" aria-labelledby="about-title">
      <div className="container about-layout">
        <Reveal className="about-story">
          ...
          <p>
            Moving to the United States taught me to ask questions, work through unfamiliar systems,
            and keep learning. That perspective carries into my projects: I’m interested in software
            that makes a difficult process easier to understand.
          </p>
          <p>
